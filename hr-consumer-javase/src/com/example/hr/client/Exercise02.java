...
public class Exercise02 {
	...
	public static void main(String[] args) {
		...
		var postRequest = HttpRequest.newBuilder(URI.create("http://localhost:9100/hr/api/v1/employees"))
				.header("Content-Type", "application/json")                  
				.POST(BodyPublishers.ofString("""
{
	"identity": "40608049742",
	"firstName": "kate",
	"lastName": "austen",
	"iban": "TR630006264281638541318838",
	"salary": 100000.0,
	"currency": "EUR",
	"departments": [
		"IT",
	...
	"photo": ""
				                  ...
				                  .build();
		try {
			var response= httpClient.send(postRequest, BodyHandlers.ofString()).body();
