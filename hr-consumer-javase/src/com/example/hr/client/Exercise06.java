...
public class Exercise06 {
	private static final String HR_WS_API = "ws://localhost:9100/hr/api/v1/hr-events";

	public static void main(String[] args) throws InterruptedException {
		var listener = new HrWebSocketClientListener();
...
class HrWebSocketClientListener implements Listener {
